...
public class FuncionarioView extends javax.swing.JDialog {
    ...
    public void setjTextField1(JTextField jTextFieldBuscar) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "RG", "Usuario", "Senha", "Fone 1", "Fone 2", "Email", "Status", "Logradouro", "CEP", "Complemento de Endereço"
            }
        ));
        ...
        comboBoxFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nome", "CPF", "RG", "Usuario", "Logradouro", "CEP", "ComplementoEndereco" }));
